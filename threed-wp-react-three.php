...
function threed_wp_react_three_enqueue_scripts() {
    ...
    if (is_singular()) {
        ...
        if (isset($post) && has_shortcode($post->post_content, 'threed_wp_react_three')) {
            ...
            //     plugin_dir_url(__FILE__) . 'threed-wp-react-three/build/static/js/main.e3c3c464.js',
            //     array(),
            //     '1.0',
            //     [
            //         // strategy: 
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (rootElement) {
                ...
                script.src = '<?php echo plugin_dir_url(__FILE__) . 'threed-wp-react-three/build/static/js/main.e3c3c464.js'; ?>';
